...
int main(int argc, char *argv[])
{
    ...
    // geometry_msgs::TransformStamped tfs_map2map_ned_test;
    // tfs_map2map_ned_test.header.stamp = ros::Time::now();
    // tfs_map2map_ned_test.header.frame_id = "world";
    // tfs_map2map_ned_test.child_frame_id = "map";
    // tfs_map2map_ned_test.transform.translation.x = 0;
    // tfs_map2map_ned_test.transform.translation.y = 0;
    // tfs_map2map_ned_test.transform.translation.z = 0;
    // tfs_map2map_ned_test.transform.rotation.x = 0.0104846;
    // tfs_map2map_ned_test.transform.rotation.y = -0.829494;
    // tfs_map2map_ned_test.transform.rotation.z = -0.00121953;
    // tfs_map2map_ned_test.transform.rotation.w = 0.558416;
    // static_broadcaster_pub.sendTransform(tfs_map2map_ned_test);
